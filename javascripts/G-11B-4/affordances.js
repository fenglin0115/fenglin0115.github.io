...
params.ggbBase64 = ggb_G_11B_4_cover;
...
function showA1() {
    ...
    $(".outlines").hide();
    $("#outlineA1").show();
    $(".title > span ").html("G-11B-4 活動1：由球心在原點之球面上的經緯度計算空間坐標");
    params.id = "ggbApplet01_1";
    params.ggbBase64 = ggb_G_11B_4_A1_1;
...
//     params.ggbBase64 = ggb_G_11B_4_A2_1;
//     applet = new GGBApplet(params, true);
//     applet.inject('ggb-element');
...
function A1_operation1() {
    currentStage = "A1_operation1";
    loadApplet("ggbApplet01_1", ggb_G_11B_4_A1_1);
}
...
function A1_operation2() {
    ...
    loadApplet("ggbApplet01_2", ggb_G_11B_4_A1_2);
}
...
function A1_operation3() {
    ...
    loadApplet("ggbApplet01_3", ggb_G_11B_4_A1_3);
}
...
function A1_operation4() {
    ...
    loadApplet("ggbApplet01_4", ggb_G_11B_4_A1_4);
}
...
//     let A1_observation4_input2_usrans = $('#A1_observation4_input2').val();
//     let A1_observation4_input3_usrans = $('#A1_observation4_input3').val();
//     if (A1_observation4_input1_usrans == 20 && 
//         A1_observation4_input2_usrans == 4 &&
//         A1_observation4_input3_usrans == 3.71 ) {
