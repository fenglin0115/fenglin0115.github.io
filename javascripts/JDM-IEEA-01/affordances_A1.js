function showA1() {
    ...
    $(".outlines").hide();
    $("#outlineA1").show();
    $(".title > span ").html("活動1：探討什麼時候會有不確定性");
    params.id = "ggbApplet01";
    params.ggbBase64 = ggb_JDM_IEEA_01_A1a;
    applet = new GGBApplet(params, true);
    applet.inject('ggb-element');
    currentStage = "A1_operation1a";
    showWorksheetsContents("A1_operation1a_link");
    $(".outline").click(function() {
        showWorksheetsContents(this.id);
    });
}

function A1_operation1a() {
    currentStage = "A1_operation1a";
    loadApplet("ggbApplet01a", ggb_JDM_IEEA_01_A1a);
}
