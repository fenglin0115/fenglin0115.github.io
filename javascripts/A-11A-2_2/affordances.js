...
params.ggbBase64 = ggb_A_11A_2_2_cover;
...
function showA1() {
    ...
    $(".outlines").hide();
    $("#outlineA1").show();
    $(".title > span ").html("A-11A-2(2) 活動1：矩陣列運算解二元一次聯立方程式");
    params.id = "ggbApplet01_1";
    params.ggbBase64 = ggb_A_11A_2_2_A1_1;
...
function showA2() {
    ...
    params.ggbBase64 = ggb_A_11A_2_2_A2_1;
    applet = new GGBApplet(params, true);
    applet.inject('ggb-element');
...
function A1_operation1() {
    currentStage = "A1_operation1";
    loadApplet("ggbApplet01_1", ggb_A_11A_2_2_A1_1);
}
...
function A1_operation2() {
    ...
    loadApplet("ggbApplet01_2", ggb_A_11A_2_2_A1_2);
}
...
function A2_operation1() {
    currentStage = "A2_operation1";
    loadApplet("ggbApplet02_1", ggb_A_11A_2_2_A2_1);
}
...
function A2_operation2() {
    ...
    loadApplet("ggbApplet02_2", ggb_A_11A_2_2_A2_2);
}
