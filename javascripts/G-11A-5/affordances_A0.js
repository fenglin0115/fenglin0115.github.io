function showA0() {
    ...
    $(".outlines").hide();
    $("#outlineA0").show();
    $(".title > span ").html("活動0：直角三角形的邊角關係");
    params.id = "ggbApplet01";
    params.ggbBase64 = ggb_G_11A_5_A0;
...
function A0_observation1_check() {
    ...
    if($("#A0_observation1_input1").val() == "6") {
        $("#A0_observation1_input1").removeClass("btn-light");
        $("#A0_observation1_input1").removeClass("btn-danger");
        $("#A0_observation1_input1").addClass("btn-success");
        $("#A0_observation1_input1").addClass("disabled");
    } else {
        $("#A0_observation1_input1").removeClass("btn-light");
        $("#A0_observation1_input1").addClass("btn-danger");
    }

    if($("#A0_observation1_input2").val() == "0") {
        $("#A0_observation1_input2").removeClass("btn-light");
        $("#A0_observation1_input2").removeClass("btn-danger");
        $("#A0_observation1_input2").addClass("btn-success");
        $("#A0_observation1_input2").addClass("disabled");
    } else {
        $("#A0_observation1_input2").removeClass("btn-light");
        $("#A0_observation1_input2").addClass("btn-danger");
    }

    if($("#A0_observation1_input3").val() == "6") {
        $("#A0_observation1_input3").removeClass("btn-light");
        $("#A0_observation1_input3").removeClass("btn-danger");
        $("#A0_observation1_input3").addClass("btn-success");
        $("#A0_observation1_input3").addClass("disabled");
    } else {
        $("#A0_observation1_input3").removeClass("btn-light");
        $("#A0_observation1_input3").addClass("btn-danger");
    }

    if($("#A0_observation1_input4").val() == "0") {
        $("#A0_observation1_input4").removeClass("btn-light");
        $("#A0_observation1_input4").removeClass("btn-danger");
        $("#A0_observation1_input4").addClass("btn-success");
        $("#A0_observation1_input4").addClass("disabled");
    } else {
        $("#A0_observation1_input4").removeClass("btn-light");
        $("#A0_observation1_input4").addClass("btn-danger");
    }

    if($("#A0_observation1_input5").val() == "5") {
        $("#A0_observation1_input5").removeClass("btn-light");
        $("#A0_observation1_input5").removeClass("btn-danger");
        $("#A0_observation1_input5").addClass("btn-success");
        $("#A0_observation1_input5").addClass("disabled");
    } else {
        $("#A0_observation1_input5").removeClass("btn-light");
        $("#A0_observation1_input5").addClass("btn-danger");
    }

    if($("#A0_observation1_input6").val() == "1") {
        $("#A0_observation1_input6").removeClass("btn-light");
        $("#A0_observation1_input6").removeClass("btn-danger");
        $("#A0_observation1_input6").addClass("btn-success");
        $("#A0_observation1_input6").addClass("disabled");
    } else {
        $("#A0_observation1_input6").removeClass("btn-light");
        $("#A0_observation1_input6").addClass("btn-danger");
    }

    if($("#A0_observation1_input7").val() == "5") {
        $("#A0_observation1_input7").removeClass("btn-light");
        $("#A0_observation1_input7").removeClass("btn-danger");
        $("#A0_observation1_input7").addClass("btn-success");
        $("#A0_observation1_input7").addClass("disabled");
    } else {
        $("#A0_observation1_input7").removeClass("btn-light");
        $("#A0_observation1_input7").addClass("btn-danger");
    }

    if($("#A0_observation1_input8").val() == "1") {
        $("#A0_observation1_input8").removeClass("btn-light");
        $("#A0_observation1_input8").removeClass("btn-danger");
        $("#A0_observation1_input8").addClass("btn-success");
        $("#A0_observation1_input8").addClass("disabled");
    } else {
        $("#A0_observation1_input8").removeClass("btn-light");
        $("#A0_observation1_input8").addClass("btn-danger");
    }

    if($("#A0_observation1_input9").val() == "4") {
        $("#A0_observation1_input9").removeClass("btn-light");
        $("#A0_observation1_input9").removeClass("btn-danger");
        $("#A0_observation1_input9").addClass("btn-success");
        $("#A0_observation1_input9").addClass("disabled");
    } else {
        $("#A0_observation1_input9").removeClass("btn-light");
        $("#A0_observation1_input9").addClass("btn-danger");
    }

    if($("#A0_observation1_input10").val() == "2") {
        $("#A0_observation1_input10").removeClass("btn-light");
        $("#A0_observation1_input10").removeClass("btn-danger");
        $("#A0_observation1_input10").addClass("btn-success");
        $("#A0_observation1_input10").addClass("disabled");
    } else {
        $("#A0_observation1_input10").removeClass("btn-light");
        $("#A0_observation1_input10").addClass("btn-danger");
    }

    if($("#A0_observation1_input11").val() == "4") {
        $("#A0_observation1_input11").removeClass("btn-light");
        $("#A0_observation1_input11").removeClass("btn-danger");
        $("#A0_observation1_input11").addClass("btn-success");
        $("#A0_observation1_input11").addClass("disabled");
    } else {
        $("#A0_observation1_input11").removeClass("btn-light");
        $("#A0_observation1_input11").addClass("btn-danger");
    }

    if($("#A0_observation1_input12").val() == "2") {
        $("#A0_observation1_input12").removeClass("btn-light");
        $("#A0_observation1_input12").removeClass("btn-danger");
        $("#A0_observation1_input12").addClass("btn-success");
        $("#A0_observation1_input12").addClass("disabled");
    } else {
        $("#A0_observation1_input12").removeClass("btn-light");
        $("#A0_observation1_input12").addClass("btn-danger");
    }

    if($("#A0_observation1_input13").val() == "3") {
        $("#A0_observation1_input13").removeClass("btn-light");
        $("#A0_observation1_input13").removeClass("btn-danger");
        $("#A0_observation1_input13").addClass("btn-success");
        $("#A0_observation1_input13").addClass("disabled");
    } else {
        $("#A0_observation1_input13").removeClass("btn-light");
        $("#A0_observation1_input13").addClass("btn-danger");
    }

    if($("#A0_observation1_input14").val() == "3") {
        $("#A0_observation1_input14").removeClass("btn-light");
        $("#A0_observation1_input14").removeClass("btn-danger");
        $("#A0_observation1_input14").addClass("btn-success");
        $("#A0_observation1_input14").addClass("disabled");
    } else {
        $("#A0_observation1_input14").removeClass("btn-light");
        $("#A0_observation1_input14").addClass("btn-danger");
    }

    if($("#A0_observation1_input15").val() == "3") {
        $("#A0_observation1_input15").removeClass("btn-light");
        $("#A0_observation1_input15").removeClass("btn-danger");
        $("#A0_observation1_input15").addClass("btn-success");
        $("#A0_observation1_input15").addClass("disabled");
    } else {
        $("#A0_observation1_input15").removeClass("btn-light");
        $("#A0_observation1_input15").addClass("btn-danger");
    }

    if($("#A0_observation1_input16").val() == "3") {
        $("#A0_observation1_input16").removeClass("btn-light");
        $("#A0_observation1_input16").removeClass("btn-danger");
        $("#A0_observation1_input16").addClass("btn-success");
        $("#A0_observation1_input16").addClass("disabled");
    } else {
        $("#A0_observation1_input16").removeClass("btn-light");
        $("#A0_observation1_input16").addClass("btn-danger");
    }

    if($("#A0_observation1_input1").val() == "6" && $("#A0_observation1_input2").val() == "0" && $("#A0_observation1_input3").val() == "6" && $("#A0_observation1_input4").val() == "0" && $("#A0_observation1_input5").val() == "5" && $("#A0_observation1_input6").val() == "1" && $("#A0_observation1_input7").val() == "5" && $("#A0_observation1_input8").val() == "1" && $("#A0_observation1_input9").val() == "4" && $("#A0_observation1_input10").val() == "2" && $("#A0_observation1_input11").val() == "4" && $("#A0_observation1_input12").val() == "2" && $("#A0_observation1_input13").val() == "3" && $("#A0_observation1_input14").val() == "3" && $("#A0_observation1_input15").val() == "3" && $("#A0_observation1_input16").val() == "3") {
        Toast.fire({
            icon: "success",
            title: "答對了! 點擊【前往問題探索1】繼續下去"
        });
        $("#A0_observation1_confirm").addClass("d-none");
...
function A0_investigation1_check1() {
    if($('input[name=A0_investigation1_input1]:checked').val() == "2") {
        $('input[name=A0_investigation1_input1]').parent().css("background-color", "initial");
        $('input[name=A0_investigation1_input1]:checked').parent().css("background-color", "#ddff77");
        $('input[name=A0_investigation1_input1]').attr('disabled', 'disabled');
        Toast.fire({
            icon: "success",
            title: "答對了!<br>接續回答第2題"
        });
        $("input[name=A0_investigation1_input2]").parent().parent().removeClass("d-none");
        $("#A0_investigation1_confirm1").addClass("d-none");
        $("#A0_investigation1_confirm2").removeClass("d-none");
        var api = applet.getAppletObject();
        api.evalCommand("ShowLabel(TriSideAB, true)");
    } else {
        $('input[name=A0_investigation1_input1]:checked').parent().css("background-color", "#ffb7dd");
        Toast.fire({
            icon: "error",
            title: "請確認紅色錯誤部分"
        });
...
function A0_investigation1_check2() {
    if($('input[name=A0_investigation1_input2]:checked').val() == "1") {
        $('input[name=A0_investigation1_input2]').parent().css("background-color", "initial");
        $('input[name=A0_investigation1_input2]:checked').parent().css("background-color", "#ddff77");
        $('input[name=A0_investigation1_input2]').attr('disabled', 'disabled');
        Toast.fire({
            icon: "success",
            title: "答對了!<br>點擊【前往活動1】繼續下去"
        });
        $("input[name=A0_investigation1_input2]").parent().parent().removeClass("d-none");
        $("#A0_investigation1_confirm2").addClass("d-none");
        $("#A0_investigation1_next").removeClass("d-none");
        $("#A0_investigation1_done").css({"opacity": "1"});
        $("#A0_investigation1_link img").css({"opacity": "1"});
        var api = applet.getAppletObject();
        api.evalCommand("ShowLabel(TriSideBC, true)");
    } else {
        $('input[name=A0_investigation1_input2]:checked').parent().css("background-color", "#ffb7dd");
        Toast.fire({
            icon: "error",
            title: "請確認紅色錯誤部分"
        });
...
//     currentStage = "A0_operation1";
//     loadApplet("ggbApplet01", ggb_G_11A_5_A0);
// }
...
function A0_investigation3_next() {
