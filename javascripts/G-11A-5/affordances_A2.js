function showA2() {
    ...
    $(".outlines").hide();
    $("#outlineA2").show();
    $(".title > span ").html("活動2：認知差角公式的正確性");
    params.id = "ggbApplet02";
    params.ggbBase64 = ggb_G_11A_5_A2;
...
function A2_observation1_check1() {
    if($('input[name=A2_observation1_input1]:checked').val() == "1") {
        ...
        $("input[name=A2_observation1_input2]").parent().parent().removeClass("d-none");
        $("#A2_observation1_confirm1").addClass("d-none");
        $("#A2_observation1_confirm2").removeClass("d-none");
...
function A2_observation1_check2() {
    if($('input[name=A2_observation1_input2]:checked').val() == "2") {
        $('input[name=A2_observation1_input2]').parent().css("background-color", "initial");
        $('input[name=A2_observation1_input2]:checked').parent().css("background-color", "#ddff77");
        $('input[name=A2_observation1_input2]').attr('disabled', 'disabled');
        Toast.fire({
            icon: "success",
            title: "答對了!<br>接續回答第3題"
        });
        $("#A2_observation1_input3_option1").parent().parent().removeClass("d-none");
        $("#A2_observation1_confirm2").addClass("d-none");
        $("#A2_observation1_confirm3").removeClass("d-none");
        var api = applet.getAppletObject();
        api.evalCommand("RunClickScript(btnReset)");
        api.evalCommand("ShowLabel(TriSideEF, true)");
    } else {
        $('input[name=A2_observation1_input2]:checked').parent().css("background-color", "#ffb7dd");
        Toast.fire({
            icon: "error",
            title: "請確認紅色錯誤部分"
        });
...
function A2_observation1_check3() {
    if ($("#A2_observation1_input3_option1").is(":checked")) {
        $("#A2_observation1_input3_option1").parent().css("background-color", "#ddff77");
    } else {
        $("#A2_observation1_input3_option1").parent().css("background-color", "#ffb7dd");
    }
    if ($("#A2_observation1_input3_option2").is(":checked")) {
        $("#A2_observation1_input3_option2").parent().css("background-color", "#ddff77");
    } else {
        $("#A2_observation1_input3_option2").parent().css("background-color", "#ffb7dd");
    }
    if (!$("#A2_observation1_input3_option3").is(":checked")) {
        $("#A2_observation1_input3_option3").parent().css("background-color", "#ddff77");
    } else {
        $("#A2_observation1_input3_option3").parent().css("background-color", "#ffb7dd");
    }
    if (!$("#A2_observation1_input3_option4").is(":checked")) {
        $("#A2_observation1_input3_option4").parent().css("background-color", "#ddff77");
    } else {
        $("#A2_observation1_input3_option4").parent().css("background-color", "#ffb7dd");
    }
    if($("#A2_observation1_input3_option1").is(":checked") && $("#A2_observation1_input3_option2").is(":checked") && !$("#A2_observation1_input3_option3").is(":checked") && !$("#A2_observation1_input3_option4").is(":checked")) {
        $("#A2_observation1_input3_option1").attr('disabled', 'disabled');
        $("#A2_observation1_input3_option2").attr('disabled', 'disabled');
        $("#A2_observation1_input3_option3").attr('disabled', 'disabled');
        $("#A2_observation1_input3_option4").attr('disabled', 'disabled');
        Toast.fire({
            icon: "success",
            title: "答對了!<br>接續回答第4題"
        });
        $("input[name=A2_observation1_input4]").parent().parent().removeClass("d-none");
        $("#A2_observation1_confirm3").addClass("d-none");
        $("#A2_observation1_confirm4").removeClass("d-none");
        var api = applet.getAppletObject();
        api.evalCommand("SetVisibleInView(text7, 1, true)");
        api.evalCommand("SetVisibleInView(text8, 1, true)");
        api.evalCommand("SetColor(angleAEB, \"#0000cc\")");
        api.evalCommand("SetColor(angleCFE, \"#0000cc\")");
    } else {
        Toast.fire({
            icon: "error",
            title: "請確認紅色錯誤部分"
...
function A2_observation1_check4() {
    if($('input[name=A2_observation1_input4]:checked').val() == "1") {
        $('input[name=A2_observation1_input4]').parent().css("background-color", "initial");
        $('input[name=A2_observation1_input4]:checked').parent().css("background-color", "#ddff77");
        $('input[name=A2_observation1_input4]').attr('disabled', 'disabled');
        Toast.fire({
            icon: "success",
            title: "答對了!<br>接續回答第5題"
        });
        $("#A2_observation1_input5_option1").parent().parent().removeClass("d-none");
        $("#A2_observation1_confirm4").addClass("d-none");
        $("#A2_observation1_confirm5").removeClass("d-none");
        var api = applet.getAppletObject();
        api.evalCommand("RunClickScript(btnReset)");
        api.evalCommand("SetVisibleInView(text6, 1, true)");
    } else {
        $('input[name=A2_observation1_input4]:checked').parent().css("background-color", "#ffb7dd");
        Toast.fire({
            icon: "error",
            title: "請確認紅色錯誤部分"
        });
...
function A2_observation1_check5() {
    if($('input[name=A2_observation1_input5]:checked').val() == "2") {
        $('input[name=A2_observation1_input5]').parent().css("background-color", "initial");
        $('input[name=A2_observation1_input5]:checked').parent().css("background-color", "#ddff77");
        $('input[name=A2_observation1_input5]').attr('disabled', 'disabled');
        Toast.fire({
            icon: "success",
            title: "答對了!<br>接續回答第6題"
        });
        $("#A2_observation1_input6_option1").parent().parent().removeClass("d-none");
        $("#A2_observation1_confirm5").addClass("d-none");
        $("#A2_observation1_confirm6").removeClass("d-none");
        var api = applet.getAppletObject();
        api.evalCommand("RunClickScript(btnReset)");
        api.evalCommand("SetVisibleInView(text5, 1, true)");
    } else {
        $('input[name=A2_observation1_input5]:checked').parent().css("background-color", "#ffb7dd");
        Toast.fire({
            icon: "error",
            title: "請確認紅色錯誤部分"
        });
...
function A2_observation1_check6() {
    if($('input[name=A2_observation1_input6]:checked').val() == "3") {
        $('input[name=A2_observation1_input6]').parent().css("background-color", "initial");
        $('input[name=A2_observation1_input6]:checked').parent().css("background-color", "#ddff77");
        $('input[name=A2_observation1_input6]').attr('disabled', 'disabled');
        Toast.fire({
            icon: "success",
            title: "答對了!<br>接續回答第7題"
        });
        $("#A2_observation1_input7_option1").parent().parent().removeClass("d-none");
        $("#A2_observation1_confirm6").addClass("d-none");
        $("#A2_observation1_confirm7").removeClass("d-none");
        var api = applet.getAppletObject();
        api.evalCommand("RunClickScript(btnReset)");
        api.evalCommand("SetVisibleInView(text4, 1, true)");
    } else {
        $('input[name=A2_observation1_input6]:checked').parent().css("background-color", "#ffb7dd");
        Toast.fire({
            icon: "error",
            title: "請確認紅色錯誤部分"
        });
...
function A2_observation1_check7() {
    if($('input[name=A2_observation1_input7]:checked').val() == "4") {
        $('input[name=A2_observation1_input7]').parent().css("background-color", "initial");
        $('input[name=A2_observation1_input7]:checked').parent().css("background-color", "#ddff77");
        $('input[name=A2_observation1_input7]').attr('disabled', 'disabled');
        Toast.fire({
            icon: "success",
            title: "答對了!<br>接續回答第8題"
        });
        $("input[name=A2_observation1_input8]").parent().parent().removeClass("d-none");
        $("#A2_observation1_confirm7").addClass("d-none");
        $("#A2_observation1_confirm8").removeClass("d-none");
        var api = applet.getAppletObject();
        api.evalCommand("RunClickScript(btnReset)");
        api.evalCommand("SetVisibleInView(text3, 1, true)");
    } else {
        $('input[name=A2_observation1_input7]:checked').parent().css("background-color", "#ffb7dd");
        Toast.fire({
            icon: "error",
            title: "請確認紅色錯誤部分"
        });
...
function A2_observation1_check8() {
    if($('input[name=A2_observation1_input8]:checked').val() == "1") {
        $('input[name=A2_observation1_input8]').parent().css("background-color", "initial");
        $('input[name=A2_observation1_input8]:checked').parent().css("background-color", "#ddff77");
        $('input[name=A2_observation1_input8]').attr('disabled', 'disabled');
        Toast.fire({
            icon: "success",
            title: "答對了!<br>接續回答第9題"
        });
        $("input[name=A2_observation1_input9]").parent().parent().removeClass("d-none");
        $("#A2_observation1_confirm8").addClass("d-none");
        $("#A2_observation1_confirm9").removeClass("d-none");
        var api = applet.getAppletObject();
        api.evalCommand("SetVisibleInView(text9, 1, true)");
    } else {
        $('input[name=A2_observation1_input8]:checked').parent().css("background-color", "#ffb7dd");
        Toast.fire({
            icon: "error",
            title: "請確認紅色錯誤部分"
        });
...
function A2_observation1_check9() {
    if($('input[name=A2_observation1_input9]:checked').val() == "1") {
        $('input[name=A2_observation1_input9]').parent().css("background-color", "initial");
        $('input[name=A2_observation1_input9]:checked').parent().css("background-color", "#ddff77");
        $('input[name=A2_observation1_input9]').attr('disabled', 'disabled');
        Toast.fire({
            icon: "success",
            title: "答對了!<br>接續回答第10題"
        });
        $("input[name=A2_observation1_input10]").parent().parent().removeClass("d-none");
        $("#A2_observation1_confirm9").addClass("d-none");
        $("#A2_observation1_confirm10").removeClass("d-none");
        var api = applet.getAppletObject();
        api.evalCommand("RunClickScript(btnReset)");
        api.evalCommand("SetVisibleInView(text1, 1, true)");
    } else {
        $('input[name=A2_observation1_input9]:checked').parent().css("background-color", "#ffb7dd");
        Toast.fire({
            icon: "error",
            title: "請確認紅色錯誤部分"
        });
...
function A2_observation1_check10() {
    if($('input[name=A2_observation1_input10]:checked').val() == "2") {
        $('input[name=A2_observation1_input10]').parent().css("background-color", "initial");
        $('input[name=A2_observation1_input10]:checked').parent().css("background-color", "#ddff77");
        $('input[name=A2_observation1_input10]').attr('disabled', 'disabled');
        Toast.fire({
            icon: "success",
            title: "答對了!<br>點擊【前往問題探索1】繼續下去"
        });
        $("#A2_observation1_confirm10").addClass("d-none");
        ...
        $('input[name=A2_observation1_input10]:checked').parent().css("background-color", "#ffb7dd");
        Toast.fire({
            icon: "error",
            title: "請確認紅色錯誤部分"
        });
...
function A2_investigation1_check1() {
    if(!$("#A2_investigation1_input1_option1").is(':checked') && $("#A2_investigation1_input1_option2").is(':checked') && $("#A2_investigation1_input1_option3").is(':checked') && !$("#A2_investigation1_input1_option4").is(':checked')) {
        $("#A2_investigation1_input1_option1").attr('disabled', 'disabled');
        $("#A2_investigation1_input1_option2").attr('disabled', 'disabled');
        $("#A2_investigation1_input1_option3").attr('disabled', 'disabled');
        $("#A2_investigation1_input1_option4").attr('disabled', 'disabled');
        $("#A2_investigation1_input1_option1").parent().css("background-color", "#ddff77");
        $("#A2_investigation1_input1_option2").parent().css("background-color", "#ddff77");
        $("#A2_investigation1_input1_option3").parent().css("background-color", "#ddff77");
        $("#A2_investigation1_input1_option4").parent().css("background-color", "#ddff77");
        Toast.fire({
            icon: "success",
            title: "答對了!<br>接續回答第2題"
        });
        $("#A2_investigation1_input2").parent().parent().parent().removeClass("d-none");
        ...
        if($("#A2_investigation1_input1_option1").is(':checked')) {
            $("#A2_investigation1_input1_option1").parent().css("background-color", "#ffb7dd");
        } else {
            $("#A2_investigation1_input1_option1").parent().css("background-color", "#ddff77");
        }
        if(!$("#A2_investigation1_input1_option2").is(':checked')) {
            $("#A2_investigation1_input1_option2").parent().css("background-color", "#ffb7dd");
        } else {
            $("#A2_investigation1_input1_option2").parent().css("background-color", "#ddff77");
        }
        if(!$("#A2_investigation1_input1_option3").is(':checked')) {
            $("#A2_investigation1_input1_option3").parent().css("background-color", "#ffb7dd");
        } else {
            $("#A2_investigation1_input1_option3").parent().css("background-color", "#ddff77");
        }
        if($("#A2_investigation1_input1_option4").is(':checked')) {
            $("#A2_investigation1_input1_option4").parent().css("background-color", "#ffb7dd");
        } else {
            $("#A2_investigation1_input1_option4").parent().css("background-color", "#ddff77");
        }
        Toast.fire({
...
function A2_investigation1_check2() {
    if($("#A2_investigation1_input2").val() == "1") {
        $("#A2_investigation1_input2").removeClass("btn-light");
        $("#A2_investigation1_input2").removeClass("btn-danger");
        $("#A2_investigation1_input2").addClass("btn-success");
        $("#A2_investigation1_input2").addClass("disabled");
    } else {
        $("#A2_investigation1_input2").removeClass("btn-light");
        $("#A2_investigation1_input2").addClass("btn-danger");
    }
    if($("#A2_investigation1_input3").val() == "0") {
        $("#A2_investigation1_input3").removeClass("btn-light");
        $("#A2_investigation1_input3").removeClass("btn-danger");
        $("#A2_investigation1_input3").addClass("btn-success");
        $("#A2_investigation1_input3").addClass("disabled");
    } else {
        $("#A2_investigation1_input3").removeClass("btn-light");
        $("#A2_investigation1_input3").addClass("btn-danger");
    }

    if($("#A2_investigation1_input2").val() == "1" && $("#A2_investigation1_input3").val() == "0") {
        Toast.fire({
            icon: "success",
...
function A2_investigation2_check1() {
    if($("#A2_investigation2_input1_option1").is(':checked') && !$("#A2_investigation2_input1_option2").is(':checked') && !$("#A2_investigation2_input1_option3").is(':checked') && $("#A2_investigation2_input1_option4").is(':checked')) {
        $("#A2_investigation2_input1_option1").attr('disabled', 'disabled');
        $("#A2_investigation2_input1_option2").attr('disabled', 'disabled');
        $("#A2_investigation2_input1_option3").attr('disabled', 'disabled');
        $("#A2_investigation2_input1_option4").attr('disabled', 'disabled');
        $("#A2_investigation2_input1_option1").parent().css("background-color", "#ddff77");
        $("#A2_investigation2_input1_option2").parent().css("background-color", "#ddff77");
        $("#A2_investigation2_input1_option3").parent().css("background-color", "#ddff77");
        $("#A2_investigation2_input1_option4").parent().css("background-color", "#ddff77");
        Toast.fire({
            icon: "success",
            title: "答對了!<br>接續回答第2題"
        });
        $("#A2_investigation2_input2").parent().parent().parent().removeClass("d-none");
        $("#A2_investigation2_confirm1").addClass("d-none");
        $("#A2_investigation2_confirm2").removeClass("d-none");
    } else {
        if(!$("#A2_investigation2_input1_option1").is(':checked')) {
            $("#A2_investigation2_input1_option1").parent().css("background-color", "#ffb7dd");
        } else {
            $("#A2_investigation2_input1_option1").parent().css("background-color", "#ddff77");
        }
        if($("#A2_investigation2_input1_option2").is(':checked')) {
            $("#A2_investigation2_input1_option2").parent().css("background-color", "#ffb7dd");
        } else {
            $("#A2_investigation2_input1_option2").parent().css("background-color", "#ddff77");
        }
        if($("#A2_investigation2_input1_option3").is(':checked')) {
            $("#A2_investigation2_input1_option3").parent().css("background-color", "#ffb7dd");
        } else {
            $("#A2_investigation2_input1_option3").parent().css("background-color", "#ddff77");
        }
        if(!$("#A2_investigation2_input1_option4").is(':checked')) {
            $("#A2_investigation2_input1_option4").parent().css("background-color", "#ffb7dd");
        } else {
            $("#A2_investigation2_input1_option4").parent().css("background-color", "#ddff77");
        }
        Toast.fire({
...
function A2_investigation2_check2() {
    if($("#A2_investigation2_input2").val() == "1") {
        $("#A2_investigation2_input2").removeClass("btn-light");
        $("#A2_investigation2_input2").removeClass("btn-danger");
        $("#A2_investigation2_input2").addClass("btn-success");
        $("#A2_investigation2_input2").addClass("disabled");
    } else {
        $("#A2_investigation2_input2").removeClass("btn-light");
        $("#A2_investigation2_input2").addClass("btn-danger");
    }
    if($("#A2_investigation2_input3").val() == "0") {
        $("#A2_investigation2_input3").removeClass("btn-light");
        $("#A2_investigation2_input3").removeClass("btn-danger");
        $("#A2_investigation2_input3").addClass("btn-success");
        $("#A2_investigation2_input3").addClass("disabled");
    } else {
        $("#A2_investigation2_input3").removeClass("btn-light");
        $("#A2_investigation2_input3").addClass("btn-danger");
    }

    if($("#A2_investigation2_input2").val() == "1" && $("#A2_investigation2_input3").val() == "0") {
        Toast.fire({
            icon: "success",
            title: "答對了! 恭喜完成所有活動了~"
        });
        $("#A2_investigation2_confirm2").addClass("d-none");
