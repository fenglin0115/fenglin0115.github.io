...
params.ggbBase64 = ggb_F_12A_7_2B_cover;
...
function showA1() {
	...
	$(".outlines").hide();
	$("#outlineA1").show();
	$(".title > span ").html("G-11B-3_1 活動1：旋轉體的體積公式");
	params.id = "ggbApplet01";
	params.ggbBase64 = ggb_F_12A_7_2B_A1;
...
function showA2() {
	...
	$(".outlines").hide();
	$("#outlineA2").show();
	$(".title > span ").html("G-11B-3_1 活動2：旋轉體的體積公式求直圓錐的體積");
	params.id = "ggbApplet01";
	params.ggbBase64 = ggb_F_12A_7_2B_A2;
	params.appletOnLoad = function (api) {
		api.registerClientListener("clientListener");
	};
	applet = new GGBApplet(params, true);
