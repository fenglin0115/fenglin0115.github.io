function showA1() {
    ...
    $(".outlines").hide();
    $("#outlineA1").show();
    $(".title > span ").html("活動1：單利與複利計算");
    params.id = "ggbApplet01";
    params.ggbBase64 = ggb_F_11B_2_A1_1;
...
function A1_operation1() {
    currentStage = "A1_operation1";
    loadApplet("ggbApplet01", ggb_F_11B_2_A1_1);
}

function A1_operation2() {
    currentStage = "A1_operation2";
    loadApplet("ggbApplet02", ggb_F_11B_2_A1_2);
}

// function A1_operation3() {
//     currentStage = "A1_operation3";
//     loadApplet("ggbApplet03", ggb_F_11A_2_2_A1_3);
// }
