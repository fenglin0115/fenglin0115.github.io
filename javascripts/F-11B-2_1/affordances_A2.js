function showA2() {
    ...
    $(".outlines").hide();
    $("#outlineA2").show();
    $(".title > span ").html("活動2：由連續型複利觀察自然指數 e");
    params.id = "ggbApplet02";
    params.ggbBase64 = ggb_F_11B_2_A2_1;
...
function A2_operation1() {
    currentStage = "A2_operation1";
    loadApplet("ggbApplet03", ggb_F_11B_2_A2_1);
}

function A2_operation2() {
    currentStage = "A2_operation2";
    loadApplet("ggbApplet04", ggb_F_11B_2_A2_2);
}

function A2_operation3() {
    currentStage = "A2_operation3";
    loadApplet("ggbApplet05", ggb_F_11B_2_A2_3);
}
