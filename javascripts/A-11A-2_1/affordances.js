...
params.ggbBase64 = ggb_A_11A_2_1_cover;
...
function showA1() {
    ...
    $(".outlines").hide();
    $("#outlineA1").show();
    $(".title > span ").html("A-11A-2(1) 活動1：探索聯立方程式與增廣矩陣的關聯");
    params.id = "ggbApplet01_1";
    params.ggbBase64 = ggb_A_11A_2_1_A1_1;
...
function showA2() {
    ...
    $(".outlines").hide();
    $("#outlineA2").show();
    $(".title > span ").html("A-11A-2(1) 活動2：加減消去法與高斯消去法的連結");
    params.id = "ggbApplet02_1";
    params.ggbBase64 = ggb_A_11A_2_1_A2_1;
    applet = new GGBApplet(params, true);
    applet.inject('ggb-element');
...
function showA3() {
    ...
    $(".outlines").hide();
    $("#outlineA3").show();
    $(".title > span ").html("A-11A-2(1) 活動3：高斯消去法與矩陣列運算解聯立方程式");
    params.id = "ggbApplet03";
    params.ggbBase64 = ggb_A_11A_2_1_A3;
    applet = new GGBApplet(params, true);
    applet.inject('ggb-element');
...
function A1_operation1() {
    currentStage = "A1_operation1";
    loadApplet("ggbApplet01_1", ggb_A_11A_2_1_A1_1);
}
...
function A1_operation2() {
    ...
    loadApplet("ggbApplet01_2", ggb_A_11A_2_1_A1_2);
}
...
function A1_operation3() {
    ...
    loadApplet("ggbApplet01_3", ggb_A_11A_2_1_A1_3);
}
...
function A2_operation1() {
    currentStage = "A2_operation1";
    loadApplet("ggbApplet02_1", ggb_A_11A_2_1_A2_1);
}
...
function A2_operation2() {
    ...
    loadApplet("ggbApplet02_2", ggb_A_11A_2_1_A2_2);
}
...
function A2_operation3() {
    ...
    loadApplet("ggbApplet02_3", ggb_A_11A_2_1_A2_3);
}
...
function A2_operation4() {
    ...
    loadApplet("ggbApplet02_4", ggb_A_11A_2_1_A2_4);
}

function A2_operation4_link() {
    removeListener();
    // let api = applet.getAppletObject();
    // api.registerObjectUpdateListener("nPass", A2_operation4_check);
}
...
function A3_operation1() {
    currentStage = "A3_operation1";
    loadApplet("ggbApplet03", ggb_A_11A_2_1_A3);
}
...
//     let A3_observation1_input1_3_usrans = $('#A3_observation1_input1_3').val();
...
//     let A3_observation1_input2_3_usrans = $('#A3_observation1_input2_3').val();
...
//     let A3_observation1_input3_3_usrans = $('#A3_observation1_input3_3').val();
//     let A3_observation1_input4_1_usrans = $('#A3_observation1_input4_1').val();
//     let A3_observation1_input4_2_usrans = $('#A3_observation1_input4_2').val();
//     let A3_observation1_input4_3_usrans = $('#A3_observation1_input4_3').val();
//     if (A3_observation1_input1_1_usrans == 0 && 
//         A3_observation1_input1_2_usrans == 0 && 
//         A3_observation1_input1_3_usrans == 2.6926 && 
//         A3_observation1_input2_1_usrans == 1 && 
//         A3_observation1_input2_2_usrans == 1 && 
//         A3_observation1_input2_3_usrans == 2.71457 && 
//         A3_observation1_input3_1_usrans == 2 && 
//         A3_observation1_input3_2_usrans == 2 && 
//         A3_observation1_input3_3_usrans == 2.71813 && 
//         A3_observation1_input4_1_usrans == 3 && 
//         A3_observation1_input4_2_usrans == 3 &&
//         A3_observation1_input4_3_usrans == 2.71828 ) {
//         $("#A2_investigation1_input1_1").html(katex.renderToString("52", { throwOnError: false }));
//         $("#A2_investigation1_input1_2").html(katex.renderToString("\\dfrac{\\ 1\\ }{52}", { throwOnError: false }));
//         $("#A2_investigation1_input1_3").html(katex.renderToString("2.6926", { throwOnError: false }));
//         $("#A2_investigation1_input2_1").html(katex.renderToString("365", { throwOnError: false }));
...
//             $("#A3_investigation2_explain").removeClass("d-none");
