...
params.ggbBase64 = ggb_G_11A_9_cover;
...
const activities = [
    new Activity("A1_operation1", ggb_G_11A_9_A1_1, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A1_observation1", ggb_G_11A_9_A1_1, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A1_investigation1", ggb_G_11A_9_A1_1, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A1_operation2", ggb_G_11A_9_A1_1, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A1_observation2", ggb_G_11A_9_A1_1, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A1_operation3", ggb_G_11A_9_A1_2, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A1_observation3", ggb_G_11A_9_A1_2, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A1_investigation2", ggb_G_11A_9_A1_2, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A2_operation1", ggb_G_11A_9_A2_1, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A2_observation1", ggb_G_11A_9_A2_1, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A2_investigation1", ggb_G_11A_9_A2_1, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A2_operation2", ggb_G_11A_9_A2_2, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A2_observation2", ggb_G_11A_9_A2_2, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A2_investigation2", ggb_G_11A_9_A2_2, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A3_operation1", ggb_G_11A_9_A3_1, {
        validate: (self, appletData, target) => {
            self.complete = true;
        },
    }),
    new Activity("A3_observation1", ggb_G_11A_9_A3_1, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
    new Activity("A3_investigation1", ggb_G_11A_9_A3_1, {
        validate: (self, appletData) => {
            self.complete = true;
        },
    }),
