...
params.ggbBase64 = ggb_F_11A_2_1_cover;
...
$(document).ready(function() {
    ...
    $("#A1_investigation1_confirm3").click(function() {
        A1_investigation1_check3();
    });

    $("#A1_investigation1_confirm4").click(function() {
        A1_investigation1_check4();
    });

    $("#A1_investigation1_confirm5").click(function() {
        A1_investigation1_check5();
    });

    $("#A1_investigation1_confirm6").click(function() {
        A1_investigation1_check6();
    });
    ...
    $("#A2_investigation1_confirm3").click(function() {
        A2_investigation1_check3();
    });

    $("#A2_investigation1_confirm4").click(function() {
        A2_investigation1_check4();
    });

    $("#A2_investigation1_confirm5").click(function() {
        A2_investigation1_check5();
    });
});