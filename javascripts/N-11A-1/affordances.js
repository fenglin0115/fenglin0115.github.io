...
params.ggbBase64 = ggb_N_11A_1_cover;
...
function showA1() {
    ...
    $(".outlines").hide();
    $("#outlineA1").show();
    $(".title > span ").html("N-11A-1 活動1：弧度量與弧長");
    params.id = "ggbApplet01_1";
    params.ggbBase64 = ggb_N_11A_1_A1_1;
...
function showA2() {
    ...
    $(".outlines").hide();
    $("#outlineA2").show();
    $(".title > span ").html("N-11A-1 活動2：扇形面積及其應用");
    params.id = "ggbApplet02_1";
    params.ggbBase64 = ggb_N_11A_1_A2_1;
    applet = new GGBApplet(params, true);
    applet.inject('ggb-element');
...
function A1_operation1() {
    currentStage = "A1_operation1";
    loadApplet("ggbApplet01_1", ggb_N_11A_1_A1_1);
}
...
function A1_operation2() {
    ...
    loadApplet("ggbApplet01_2", ggb_N_11A_1_A1_2);
}
...
function A2_operation1() {
    currentStage = "A2_operation1";
    loadApplet("ggbApplet02_1", ggb_N_11A_1_A2_1);
}
...
function A2_operation3() {
    ...
    loadApplet("ggbApplet02_2", ggb_N_11A_1_A2_2);
}
